  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl h-[90vh] p-0 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-red-600 via-orange-500 to-amber-500 p-6 text-white">
          <DialogTitle className="text-2xl font-bold flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center font-bold text-xl">
              {table.table_number}
            </div>
            <div>
              <span>Take Order - Table {table.table_number}</span>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-96 flex flex-col bg-zinc-50 dark:bg-zinc-900">
            {/* Customer Info */}
            <div className="p-4 border-b space-y-3">
            ...
            {/* Payment & Total */}
            <div className="p-4 border-t bg-white dark:bg-zinc-800 space-y-3">
              {/* Payment Method */}
              ...
              {/* Submit Button */}
              <Button
                className="w-full h-12 text-lg bg-gradient-to-r from-red-600 via-orange-500 to-amber-500 hover:from-red-700 hover:via-orange-600 hover:to-amber-600 text-white shadow-lg"
