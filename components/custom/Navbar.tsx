...
function Navbar() {
  ...
  // Sheet handles scroll lock internally — no manual override needed
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-red-200/60 bg-gradient-to-r from-primary/5 via-orange-500/5 to-primary/5">
            <div className="flex items-center gap-2.5">
              ...
              <div className="leading-none">
                <p className="text-base font-bebas tracking-wider text-primary">ZOIRO</p>
                <p className="text-[9px] text-muted-foreground tracking-widest uppercase">Premium Broast</p>
              </div>
            </div>
          </div>
            ...
            <div className="mx-4 mt-4 p-4 bg-white/70 rounded-2xl border border-red-200/50 relative overflow-hidden flex-shrink-0 shadow-sm">
              ...
              <div className="relative flex items-center gap-3">
                <div className="relative flex-shrink-0">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-orange-500 text-white flex items-center justify-center text-xl font-bold shadow-lg">
                    {user.name?.charAt(0).toUpperCase() || 'U'}
                  </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <span className={`w-1.5 h-1.5 rounded-full bg-green-500 ${disableAnimations ? '' : 'animate-pulse'}`} />
                    <span className="text-[10px] text-green-600 font-medium">Active Now</span>
                  </div>
                </div>
              </div>
            ...
            {user && (
              <>
                <div className="pt-3 pb-1">
                  <p className="px-2 text-[11px] font-bold text-muted-foreground uppercase tracking-widest flex items-center gap-2">
                    <span className="flex-1 h-px bg-border/50" /> My Account <span className="flex-1 h-px bg-border/50" />
                  </p>
                </div>
                ...
                <button
                  onClick={handleSignOut}
                  className="w-full flex items-center gap-3 py-3 px-3.5 rounded-xl text-sm font-semibold text-red-500 hover:bg-red-500/10 transition-all duration-150"
                >
