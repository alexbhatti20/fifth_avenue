...
import { AlertTriangle, Clock, LogOut, ShieldX, Mail, HelpCircle } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
interface BlockedCustomerDialogProps {
  open: boolean;
  reason: string;
  onLogout: () => void;
...
export function BlockedCustomerDialog({
  open,
  reason,
  onLogout,
  autoLogoutSeconds = 5,
}: BlockedCustomerDialogProps) {
    ...
    <Dialog open={open} onOpenChange={() => {}}>
      ...
      >
        <DialogHeader className="text-center">
          <div className="mx-auto mb-4 h-16 w-16 rounded-full bg-red-100 dark:bg-red-900/50 flex items-center justify-center">
        ...
        <div className="flex flex-col gap-2 mt-2">
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() => window.location.href = 'mailto:support@zoirobroast.com'}
            >
