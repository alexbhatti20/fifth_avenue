...
export default function PerksPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      setLoading(true);
      await Promise.all([fetchSettings(), fetchCustomers(), fetchPromos()]);
      setLoading(false);
    };
    loadData();
  }, [fetchSettings, fetchCustomers, fetchPromos]);
                  ...
                  <div className="flex-1 grid grid-cols-4 gap-4">
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onChange={(e) => updateThreshold(index, "points", e.target.value === "" ? 0 : parseInt(e.target.value))}
                      />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onChange={(e) => updateThreshold(index, "value", e.target.value === "" ? 0 : parseInt(e.target.value))}
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <Input
                        ...
                        onChange={(e) => updateThreshold(index, "max_discount", e.target.value ? parseInt(e.target.value) : undefined)}
                      />
                    </div>
                  </div>
