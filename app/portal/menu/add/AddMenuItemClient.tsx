...
import { createMenuItemAdvanced } from '@/lib/actions';
...
interface AddMenuItemClientProps {
  categories: Category[];
}

export default function AddMenuItemClient({ categories }: AddMenuItemClientProps) {
  ...
  const handleSubmit = async () => {
    ...
    setIsLoading(true);
    try {
      const result = await createMenuItemAdvanced({
